...
class md25_motor
{
  ...
  /// \brief Motor system
  public: void MotorSystem(const UpdateInfo &_info, EntityComponentManager &_ecm, md25_plugin_o2Private* _dataPtr,const double &_dt);
};
...
class md25_plugin_o2
    : public System, 
      public ISystemPreUpdate, 
      public ISystemConfigure
{
  public: md25_plugin_o2();
  public: ~md25_plugin_o2() override;
  ...
  private: std::unique_ptr<md25_plugin_o2Private> dataPtr;
};
