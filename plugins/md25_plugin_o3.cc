...
int md25_plugin_o3Private::LoadMotorConfig(const std::shared_ptr<const sdf::Element> &_sdf, EntityComponentManager &_ecm)
{
  // Load joint
  ...
  {
    ignerr << "md25_plugin_o3 found an empty left_joint parameter. "
  ...
  else
  {
    ...
    if (this->leftMotor.jointEntity == kNullEntity)
    {
      ...
      << "The md25_plugin_o3 may not control this joint.\n";
  ...
  {
    ignerr << "md25_plugin_o3 found an empty right_joint parameter. "
           << "This joint will not be initialized.\n";
  }
  else
  {
  ...
  {
    ignerr << "No valid joints found. The md25_plugin_o3 will not be initialized.\n";
    return -1;
  }
...
void md25_plugin_o3Private::AdvertiseTopics(const std::shared_ptr<const sdf::Element> &_sdf, EntityComponentManager &_ecm)
{
...
int md25_plugin_o3Private::ValidateParameters() {
...
md25_plugin_o3::md25_plugin_o3(): dataPtr(std::make_unique<md25_plugin_o3Private>())
{
}

md25_plugin_o3::~md25_plugin_o3()
{
}

void md25_plugin_o3::Configure(const Entity &_entity,
                           ...
                           EventManager &/*_eventMgr*/)
{
  ...
  {
    ignerr << "md25_plugin_o3 should be attached to a model entity. "
...
void md25_plugin_o3::PreUpdate(const UpdateInfo &_info,
    EntityComponentManager &_ecm)
{
  ...
  // Calculate maximum allowed voltage step in 10ms for current sampling time
  dataPtr->maxVoltageIncreasePerStep = dataPtr->maxUpdateSteps * dataPtr->voltageQuantizationStep*dt*10/0.025;
...
void md25_motor::MotorSystem(const UpdateInfo &_info, EntityComponentManager &_ecm, md25_plugin_o3Private* _dataPtr, const double &_dt)
{
  ...
  if (_info.simTime - this->prevVoltUpdateTime >= std::chrono::milliseconds(10))
  {
...
IGNITION_ADD_PLUGIN(md25_plugin_o3,
    System,
    md25_plugin_o3::ISystemPreUpdate,
    md25_plugin_o3::ISystemConfigure)

IGNITION_ADD_PLUGIN_ALIAS(md25_plugin_o3,
                          "icai_crl_gazebo::MD25PluginO3")